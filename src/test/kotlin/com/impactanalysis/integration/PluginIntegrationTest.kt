package com.impactanalysis.integration

import com.impactanalysis.ImpactAnalysisPlugin
...
class PluginIntegrationTest {
    ...
    fun `test extension can be configured`() {
        ...
        rootProject.extensions.configure<com.impactanalysis.extension.ImpactAnalysisExtension>("impactAnalysis") { extension ->
        ...
        val extension = rootProject.extensions.getByName("impactAnalysis")
                as com.impactanalysis.extension.ImpactAnalysisExtension
